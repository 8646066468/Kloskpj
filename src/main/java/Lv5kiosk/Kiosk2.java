...
public class Kiosk2 {
    private final List<Menu1> menus; // 관리하는 메뉴 카테고리 리스트

    // 생성자: 메뉴 카테고리 리스트를 받아 초기화
    public Kiosk2(List<Menu1> menus) {
        this.menus = menus;
    }
    ...
    public void start() {
        ...
        while (true) {
            ...
            Menu1 selectedMenu = menus.get(categoryChoice - 1);
            ...
            MenuItem4 selectedItem = selectedMenu.getMenuItems().get(itemChoice - 1);
